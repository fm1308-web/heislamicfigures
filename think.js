...
function _showThinkMethodology(){
  ...
  box.innerHTML='<button id="think-method-close" style="position:absolute;top:12px;right:16px;background:none;border:none;color:#888;font-size:var(--fs-1);cursor:pointer;line-height:1">×</button>'
    ...
    +'<ul style="color:#ccc;font-size:var(--fs-3);line-height:1.6;padding-left:20px;margin:8px 0">'
    +'<li><b>Level 1 — Definition.</b> 475 concepts each have a written summary that defines the concept in plain language.</li>'
    +'<li><b>Level 2 — Root Match.</b> The Quran is filtered to verses that contain the concept\'s Arabic root word. Wide net. Low confidence on its own.</li>'
    ...
    +'</ul>'
    +'<p style="color:#ccc;font-size:var(--fs-3);line-height:1.6">Result: <b>125 of 475 concepts, 1,479 verse links</b>. Every verse shown survived all three filters. 350 concepts had no surviving verses and show no Quran chip — that is honest, not a bug.</p>'
    ...
    +'<p style="color:#ccc;font-size:var(--fs-3);line-height:1.6">Every Quran verse link carries the stamp <b>medium_ai</b>. Translation: the AI judged it YES under a clear rule, but a human scholar has not yet signed off each one. Human review is in progress. If you find a verse you believe was wrongly kept or wrongly dropped, use the feedback button — we want to know. Every link has since been re-checked twice — once by a stricter AI reading the English, once by an independent vetter. Links that did not clearly teach the concept were removed.</p>'
