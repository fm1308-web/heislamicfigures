...
function renderInfo(p){
  ...
  document.getElementById('infoScroll').innerHTML=`
    ...
    ${((p.dob_s||'')+(p.dod_s||'')).toLowerCase().includes('legendary')?`<div style="font-size:10px;color:rgba(160,174,192,.55);margin:-4px 0 10px 2px;line-height:1.4">Source: Ibn Ishaq, <i>Sirat Rasul Allah</i>; al-Tabari, <i>Tarikh al-Rusul wa al-Muluk</i></div>`:''}
